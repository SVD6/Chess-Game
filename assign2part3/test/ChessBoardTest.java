...
public class ChessBoardTest {
    ...
    public void setUp() {
        ...
        coordinates[6] = new Coordinate("a7"); pieces[6] = new Pawn(ChessColour.WHITE);
        coordinates[7] = new Coordinate("b7"); pieces[7] = new Pawn(ChessColour.WHITE);
        coordinates[8] = new Coordinate("c7"); pieces[8] = new Pawn(ChessColour.WHITE);
        coordinates[9] = new Coordinate("d7"); pieces[9] = new Pawn(ChessColour.WHITE);
